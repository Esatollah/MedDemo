  ...
  return (
    <FormWrap>
        <form onSubmit={(e) =>handleSubmit(e)}>
            ...
            <input className="insurance" type="number" id="pin" value={vpin} onChange={(e) => setVpin(e.target.value)} name="pin" size="4" minLength="4"maxLength="4" required/>
            <input className="insurance" type="number" id="bday" value={vbday} onChange={(e) => setVbday(e.target.value)} name="bday" size="6" minLength={6} maxLength={6} required/> <br/>
