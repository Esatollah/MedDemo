  ...
  return (
    <FormWrap>
        <form onSubmit={(e) =>handleSubmit(e)}>
            ...
            onChange={(e) => setVpin(e.target.value)} name="pin" pattern="[0-9]+" size="4" minLength="4"maxLength="4" required/>
            ...
            <label htmlFor="anmerkungen" >Anmerkungen (Rufnummer, Magistralrezeptur etc.)</label> <br/>
            <textarea id="anmerkungen"value={anmerkungen} onChange={(e) => setAnmerkungen(e.target.value)} name="message" rows="10" cols="30" className='textarea' maxLength="254">
            </textarea> <br/>
